! function (t) {
    ...
    return h.extend(!0, s.defaults, {
                ...
                for (t = 0, n = a.length; t < n; t++)
                    if (s = a[t], h.isArray(s)) w(e, s);
                        ...
                        u && (o = h("<li>", {
                            ...
                            id: 0 === d && "string" == typeof s ? i.sTableId + "_" + s : null
                        }).append(h("<a>", {
                            href: "#",
                            ...
                            class: "page-link"
                        }).html(u)).appendTo(e), i.oApi._fnBindAction(o, {
                            action: s
                        }, r), x++)
                    }
            };
        ...
        w(h(e).empty().html('<ul class="pagination"/>').children("ul"), a), t !== o && h(e).find("[data-dt-idx=" + t + "]").focus()
    }, s
});
