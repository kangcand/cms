 <nav class="top-toolbar navbar navbar-desktop flex-nowrap">
     ...
     <ul class="navbar-nav nav-right">
                         ...
                         <div class="card-container-wrapper">
                             ...
                             <div class="card-container">
                                 ...
                                 <div class="row m-b-20 m-t-30">
                                     ...
                                     <div class="col-2"><input type="checkbox" class="js-switch" checked />
                                     </div>
                                 </div>
         ...
         <li class="nav-item dropdown">
             <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                 aria-expanded="false">
                 <img src="{{ asset('assets/backend/assets/img/avatars/1.jpg')}}" class="w-35 rounded-circle"
                     alt="Albert Einstein">
             </a>
             <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                 ...
                 <a class="dropdown-item" href="apps.messages.html"><i class="icon dripicons-mail"></i>
                     Message <span class="badge badge-accent rounded-circle w-15 h-15 p-0 font-size-10">4</span></a>
                 ...
                 <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                         ...
                         class="icon dripicons-lock-open"></i>
                     Sign Out</a>
     ...
     <form role="search" action="http://www.authenticgoods.co/themes/quantum-pro/demos/demo1/pages.search.html"
         class="navbar-form">
