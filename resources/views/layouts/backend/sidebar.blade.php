         ...
         <div class="aside-toolbar">
             <ul class="site-logo">
                 <li>
                     <!-- START LOGO -->
                     <a href="{{ url('/admin') }}">
                         <div class="logo" style="top: 18px;">
                             <img src="{{ asset('assets/img/logo1.png') }}" style="width:30px; height:30px;" alt="logo">
         ...
         <nav class="main-menu">
             <ul class="nav metismenu">
                 ...
                 <li class="nav-dropdown active">
                     <a class="has-arrow" href="{{ url('/admin') }}" aria-expanded="false"><i
                             class="icon dripicons-meter"></i><span>Dashboard</span></a>
                 </li>
                 <li class="nav-dropdown">
                     <a class="has-arrow" href="#" aria-expanded="false"><i
                             class="icon dripicons-article"></i><span>Manajemen Blog</span></a>
                     <ul class="collapse nav-sub" aria-expanded="false">
                         <li><a href="{{ route('tag.index') }}"><span>Tag</span></a></li>
                         <li><a href="{{ route('kategori.index') }}"><span>Kategori</span></a></li>
                         <li><a href="{{ route('artikel.index') }}"><span>Artikel</span></a></li>
                         </li>
                     </ul>
                 </li>
                 <li class="nav-dropdown">
                 ...
                 <li class="nav-dropdown">
                     <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-jewel"></i><span>UI
                             Kit</span></a>
                     <ul class="collapse nav-sub" aria-expanded="false">
